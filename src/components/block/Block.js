...
const Block  = ({ blockName, previousHash, mine, dataInputChange }) => {
  return (
        ...
        { true ?
          <div>
            ...
            <div className="row row-style">
              ...
              <p className="content-style">Some hash</p>
            </div>
            <div className="row row-style">
              <span className="label-style">Time:</span>
              <p className="content-style">Some time</p>
            </div>
            <div className="row row-style">
              <span className="label-style">Nonce:</span>
              <p className="content-style">Some nonce</p>
            </div>
            <div className="row row-style">
